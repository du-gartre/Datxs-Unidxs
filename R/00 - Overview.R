...
# Info importante que falta
# Sexo
# Edad
# Nivel educativo
# ¿Alcaldía de residencia?

# Meter N1, N2, ... Nn, en df_agosto2
# Hacer clasificación con base en la lista de nombres
# if N1 in (lista_nombres)....
# Lista de mujeres, de hombres y numbres unisex...
# if N1 in lista_unisex <-  pasar a checar el segundo nombre.

# Todos los que tienen RESERVADO en N1, son de Secretaría de Finanzas


# Hacer el análisis por rangos salariales
# El ingreso máximo (Cheinbaum) entre 10

# Sectores que son predominados por hombres/mujeres


# Hacer un análisis dentro de las secretarías
# Mencionar que asumimos que el sueldo está correlacionado con la responsabilidad del cargo 